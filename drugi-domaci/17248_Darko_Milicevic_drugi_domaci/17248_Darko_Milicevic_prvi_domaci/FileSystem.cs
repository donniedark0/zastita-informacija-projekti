...
namespace _17248_Darko_Milicevic_prvi_domaci
{
    class FileSystem
    {
        ...
        public void EncodeXTEA(string fileName, string key)
        {
            ...
            this.WriteInFile(outputFile, cipher.ToCharArray());
        }

        public void DecodeXTEA(string path, string key)
        {
            if (this._destDirectory.Length == 0)
                throw new Exception("Please choose your destination folder!");
            ...
            string txtForDecoding = sb.ToString();
